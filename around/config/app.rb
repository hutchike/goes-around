...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'goesaround.org'
  config.app_name = 'GoesAround'
  config.mailer.from = 'GoesAround.org <no-reply@goesaround.org>'
  ...
  #
  config.app_secret = 'tMFG89Fp458wKZoXpov7bxPFsa1RX5CoCyfGntxYMk9YyMEU7D0CWV6Ab5qGP6sCLgA'
